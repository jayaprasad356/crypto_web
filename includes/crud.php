...
class Database
{
    ...
    private $db_user = "u743445510_crypto";  // Change as required
    private $db_pass = "Crypto@2022";  // Change as required
    private $db_name = "u743445510_crypto";    // Change as required
